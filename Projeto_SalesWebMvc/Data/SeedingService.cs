...
namespace Projeto_SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        private Projeto_SalesWebMvcContext _context;
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Beatriz", "bia@gmail.com", new DateTime(1995, 05, 07), 2800.0, d4);
            Seller s2 = new Seller(2, "Gael", "gaga@gmail.com", new DateTime(2019, 08, 12), 200.0, d3);
            Seller s3 = new Seller(3, "Wesley", "wesmartins@gmail.com", new DateTime(1996, 06, 16), 5500.0, d1);
            Seller s4 = new Seller(4, "Goku", "gokuZ@gmail.com", new DateTime(1985, 02, 19), 1500.0, d3);
            Seller s5 = new Seller(5, "Gohan", "gogoZ@gmail.com", new DateTime(1995, 12, 22), 6200.0, d2);
            Seller s6 = new Seller(6, "Trunks", "vegeta22@gmail.com", new DateTime(1992, 10, 15), 500.0, d2);
